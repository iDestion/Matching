...
//            list.Add("German");
            ...
            Console.WriteLine("Simple matching percentage: " + SimpleMatcher.DoMatching(team, project));
            Console.WriteLine("Weighted matching percentage: " + WeightedMatcher.DoMatching(team, project));
        }
    }
}
